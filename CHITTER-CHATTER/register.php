...
<div class="container">
  ...
  <center><h2><br>CREATE A GROUP HERE</br></h2></center>
  <form class="form-horizontal" method="post" action="add_user.php">
    ...
    <div class="form-group">
      <label class="control-label col-sm-2 col-sm-offset-2" for="name">Group Name:</label>
	  
      <div class="col-sm-5">
        <input type="text" class="form-control" id="groupname" placeholder="Enter GroupName" name="groupname" required>
      </div>
    </div>
	<div class="form-group">
